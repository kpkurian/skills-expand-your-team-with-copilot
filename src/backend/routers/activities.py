...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced').
                  Activities without a difficulty level are included for any filter value.
    """
    ...
    if difficulty:
        # Include activities matching the specified difficulty OR those with no difficulty set
        # Wrap with $and to safely combine with any other active query conditions
